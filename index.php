...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <!--	Banner Start   -->
        <div class="overlay-black w-100 slider-banner1 position-relative" style="background-image: url('images/guri2.JPG'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
                ...
                <div class="text-box-one">
                    ...
                    <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Real Estate Management system offers the best rental services in Kenya from its start and Implementation...Thus having the best rental units accross the coutry including 1, 2 and 4 bedrooms for renting.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Real Estate management managed by sharmake abas mohamed offers the best quality selling services with the best sellers accross the country, sharmake abas mohamed being the head of the sellers.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Our management holds adequate property listing accreoss the country making it the best so far...</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>This is a legal company managed by a legal manager who holds a PHP in Ptoperty management since a legal Investment under the Kenyan Government.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="text-secondary double-down-line text-center mb-4">Newest /Recent Property</h2>
                    </div>
                    <!--- <div class="col-md-6">
        ...
        <!--	Why Choose Us -->
        <div class="full-row living bg-one overlay-secondary-half" style="background-image: url('images/sharma.jpg'); background-size: cover; background-position: center center; background-repeat: yes-repeat;">
            <div class="container">
                <div class="row">
                        ...
                        <div class="living-list pr-4">
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										<h5 class="mb-3">1. Top Rated</h5>
										<p>Real Estate management is the most rated system in Kenya for managing Properties accross the country with 4 stars out of 5 in terms of Rating.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-real-estate flat-medium float-left d-table mr-4 text-success" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">2. Experience Quality</h5>
										<p>Real Estate management has a greta experience of not less than 15 years in the Management Sector accross the country.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-seller flat-medium float-left d-table mr-4 text-success" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">3. Experienced Agents</h5>
										<p>Our Agents are Highly trained in terms of handling Our custeomers.They are highly experienced with the least experienced having a 10-year experience in the management industry.</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>To all who are willing their property to be mnaged by us are allowed to communicate with us at any given time of working days(monday to friday) from 8am to 8pm and on saturdays from 9am to 5pm.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>With us, all your files and documents are highly secured and kept well for Data Breachng.Only the Admin is capable of handling customers files and Documents.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Acquire your dream managers through us and see your property investement/bussiness grow to a million miles.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/4.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
										$query=mysqli_query($con,"SELECT count(state), property.* FROM property where city='Naivasha'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['17']?>"><?php echo $row['state'];?></a></h4>
