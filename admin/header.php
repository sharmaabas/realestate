  ...
  <div class="header">
                ...
                <div class="header-left">
					...
					<a href="dashboard.php" class="logo logo-small">
						<img src="assets/img/realE.jpeg" alt="Logo" width="30" height="30">
					</a>
                </div>
				<!-- /Logo -->
                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="menu-title"> 
								<span>county and city</span>
							</li>
						
							<li class="submenu">
								<a href="#"><i class="fe fe-location"></i> <span>county and city</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
